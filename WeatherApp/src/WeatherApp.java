...
//retrieve data from API (the newest) and using GUI to display to user
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String locationName){
        ...
        try{
            ...
            // build the weather json data object that we are going to access in frontend
    ...
    public static JSONArray getLocationData(String locationName){
        // replace any " " in location name to "+" to adhere to API's request format
